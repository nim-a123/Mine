...
let wellcome = localStorage.getItem("wellcome");

let welcuner =  localStorage.getItem("welcuner");
...
function highorminuesinputvaluecheaker(){
  if(  moneygetterhaha.value < 0){

    moneygetterhaha.value = 0
  }
  if(  moneygetterhaha.value > 1000){
    moneygetterhaha.value = 50;
  }
}
...
function keydowninputcheaker(){
  ...
  if(moneygetterhaha.value >= 1000){
    ...
    moneygetterhaha.value = parseInt(1000)
  
  }
  if(moneygetterhaha.value < 1){
  
    moneygetterhaha.value = parseInt(0)
