 ...
 let money_fakebalance_shower = document.getElementById('money_fakebalance_shower');
...
moneyspammer()
 ...
 function takeout(){
     if(takeout_ajzae >4 && takeout_ajzae<30){
 ...
 function game_1_bomb2(){
     ...
     if(shuffled[0] !== 2 && shuffled[0] !==7){
        money_tabdil += addermoney;
         ...
         takeout_ajzae += 1 ;
         game_button_1_bomb2.innerHTML = '<img class="gem"src="photo/gem.png"alt="gem_icon">';
     }
     else if (shuffled[0] === 2 ||  shuffled[0] ===7){
         game_button_1_bomb2.innerHTML = '<img class="bomb bombanimetion"src="photo/bomb.png"alt="bomb_icon">';
       disabeler()
       song_bomb.play()
       money_tabdil = balance
       bakht()
 ...
 function game_2_bomb2(){
     ...
     if(shuffled[1] !== 2 && shuffled[1] !==7){
         ...
         takeout_ajzae += 1 ;
         game_button_2_bomb2.innerHTML = '<img class="gem"src="photo/gem.png"alt="gem_icon">';
         game_button_2_bomb2.disabled = true;
     }
     else if (shuffled[1] === 2 ||  shuffled[1] ===7){
         game_button_2_bomb2.innerHTML = '<img class="bomb bombanimetion"src="photo/bomb.png"alt="bomb_icon">';
         disabeler()
         takeout_ajzae += 100 ;
         song_bomb.play()
         money_tabdil = balance
 ...
 function game_3_bomb2(){
     ...
     if(shuffled[2] !== 2 && shuffled[2] !==7){
         ...
         game_button_3_bomb2.innerHTML = '<img class="gem"src="photo/gem.png"alt="gem_icon">';
         ...
         game_button_3_bomb2.innerHTML = '<img class="bomb bombanimetion"src="photo/bomb.png"alt="bomb_icon">';
         disabeler()
         takeout_ajzae += 100 ;
         song_bomb.play()
         money_tabdil = balance
 ...
 function game_4_bomb2(){
     ...
     if(shuffled[3] !== 2 && shuffled[3] !==7){
         ...
         takeout_ajzae += 1 ;
         game_button_4_bomb2.innerHTML = '<img class="gem"src="photo/gem.png"alt="gem_icon">';
     }
     else if (shuffled[3] === 2 ||  shuffled[3] ===7){
         game_button_4_bomb2.innerHTML = '<img class="bomb bombanimetion"src="photo/bomb.png"alt="bomb_icon">';
         disabeler()
         takeout_ajzae += 100 ;
         song_bomb.play()
         money_tabdil = balance
 ...
 function game_5_bomb2(){
     ...
     if(shuffled[4] !== 2 && shuffled[4] !==7){
         ...
         takeout_ajzae += 1 ;
         game_button_5_bomb2.innerHTML = '<img class="gem"src="photo/gem.png"alt="gem_icon">';
        
     }
     else if (shuffled[4] === 2 ||  shuffled[4] ===7){
         game_button_5_bomb2.innerHTML = '<img class="bomb bombanimetion"src="photo/bomb.png"alt="bomb_icon">';
         disabeler()
         song_bomb.play()
         takeout_ajzae += 100 ;
         song_bomb.play()
...
if(shuffled[5] !== 2 && shuffled[5] !==7){
 ...
 takeout_ajzae += 1 ;
 game_button_6_bomb2.innerHTML = '<img class="gem"src="photo/gem.png"alt="gem_icon">';

 
}
else if (shuffled[5] === 2 ||  shuffled[5] ===7){
 takeout_ajzae += 100 ;
 game_button_6_bomb2.innerHTML = '<img class="bomb bombanimetion"src="photo/bomb.png"alt="bomb_icon">';
 disabeler()
 song_bomb.play()
 money_tabdil = balance
 bakht()
...
if(shuffled[6] !== 2 && shuffled[6] !==7){
 ...
 takeout_ajzae += 1 ;
 game_button_7_bomb2.innerHTML = '<img class="gem"src="photo/gem.png"alt="gem_icon">';

 
}
else if (shuffled[6] === 2 ||  shuffled[6] ===7){
 takeout_ajzae += 100 ;
 game_button_7_bomb2.innerHTML = '<img class="bomb bombanimetion"src="photo/bomb.png"alt="bomb_icon">';
 disabeler()
 song_bomb.play()
 money_tabdil = balance
 bakht()
...
if(shuffled[7] !== 2 && shuffled[7] !==7){
 ...
 takeout_ajzae += 1 ;
 game_button_8_bomb2.innerHTML = '<img class="gem"src="photo/gem.png"alt="gem_icon">';

 
}
else if (shuffled[7] === 2 ||  shuffled[7] ===7){
 game_button_8_bomb2.innerHTML = '<img class="bomb bombanimetion"src="photo/bomb.png"alt="bomb_icon">';
 disabeler()
 takeout_ajzae += 100 ;
 song_bomb.play()
 money_tabdil = balance
...
if(shuffled[8] !== 2 && shuffled[8] !==7){
 ...
 takeout_ajzae += 1 ;
 game_button_9_bomb2.innerHTML = '<img class="gem"src="photo/gem.png"alt="gem_icon">';
 ...
 game_button_9_bomb2.innerHTML = '<img class="bomb bombanimetion"src="photo/bomb.png"alt="bomb_icon">';
 disabeler()
 takeout_ajzae += 100 ;
 song_bomb.play()
 money_tabdil = balance
...
if(shuffled[9] !== 2 && shuffled[9] !==7){
 ...
 money_tabdil += addermoney;
 takeout_ajzae += 1 ;
 game_button_10_bomb2.innerHTML = '<img class="gem"src="photo/gem.png"alt="gem_icon">';
 ...
 game_button_10_bomb2.innerHTML = '<img class="bomb bombanimetion"src="photo/bomb.png"alt="bomb_icon">';
 disabeler()
 takeout_ajzae += 100 ;
 song_bomb.play()
 money_tabdil = balance
...
if(shuffled[10] !== 2 && shuffled[10] !==7){
 ...
 takeout_ajzae += 1 ;
 game_button_11_bomb2.innerHTML = '<img class="gem"src="photo/gem.png"alt="gem_icon">';
 ...
 game_button_11_bomb2.innerHTML = '<img class="bomb bombanimetion"src="photo/bomb.png"alt="bomb_icon">';
 disabeler()
 takeout_ajzae += 100 ;
 song_bomb.play()
 money_tabdil = balance
...
if(shuffled[11] !== 2 && shuffled[11] !==7){
 ...
 takeout_ajzae += 1 ;
 game_button_12_bomb2.innerHTML = '<img class="gem"src="photo/gem.png"alt="gem_icon">';
 ...
 game_button_12_bomb2.innerHTML = '<img class="bomb bombanimetion"src="photo/bomb.png"alt="bomb_icon">';
 disabeler()
 takeout_ajzae += 100 ;
 song_bomb.play()
 money_tabdil = balance
...
if(shuffled[12] !== 2 && shuffled[12] !==7){
 ...
 money_tabdil += addermoney;
 takeout_ajzae += 1 ;
 game_button_13_bomb2.innerHTML = '<img class="gem"src="photo/gem.png"alt="gem_icon">';
 ...
 game_button_13_bomb2.innerHTML = '<img class="bomb bombanimetion"src="photo/bomb.png"alt="bomb_icon">';
 disabeler()
 takeout_ajzae += 100 ;
 song_bomb.play()
 money_tabdil = balance
...
if(shuffled[13] !== 2 && shuffled[13] !==7){
 ...
 takeout_ajzae += 1 ;
 game_button_14_bomb2.innerHTML = '<img class="gem"src="photo/gem.png"alt="gem_icon">';
 ...
 game_button_14_bomb2.innerHTML = '<img class="bomb bombanimetion"src="photo/bomb.png"alt="bomb_icon">';
 disabeler()
 song_bomb.play()
 takeout_ajzae += 100 ;
 money_tabdil = balance
...
if(shuffled[14] !== 2 && shuffled[14] !==7){
 ...
 takeout_ajzae += 1 ;
 game_button_15_bomb2.innerHTML = '<img class="gem"src="photo/gem.png"alt="gem_icon">';
 ...
 game_button_15_bomb2.innerHTML = '<img class="bomb bombanimetion"src="photo/bomb.png"alt="bomb_icon">';
 disabeler()
 song_bomb.play()
 takeout_ajzae += 100 ;
 money_tabdil = balance
...
if(shuffled[15] !== 2 && shuffled[15] !==7){
 ...
 money_tabdil += addermoney;
 takeout_ajzae += 1 ;
 game_button_16_bomb2.innerHTML = '<img class="gem"src="photo/gem.png"alt="gem_icon">';
 ...
 game_button_16_bomb2.innerHTML = '<img class="bomb bombanimetion"src="photo/bomb.png"alt="bomb_icon">';
 disabeler()
 song_bomb.play()
 takeout_ajzae += 100 ;
 money_tabdil = balance
...
if(shuffled[16] !== 2 && shuffled[16] !==7){
 ...
 takeout_ajzae += 1 ;
 game_button_17_bomb2.innerHTML = '<img class="gem"src="photo/gem.png"alt="gem_icon">';
 ...
 game_button_17_bomb2.innerHTML = '<img class="bomb bombanimetion"src="photo/bomb.png"alt="bomb_icon">';
 disabeler()
 song_bomb.play()
 takeout_ajzae += 100 ;
 money_tabdil = balance
...
if(shuffled[17] !== 2 && shuffled[17] !==7){
 ...
 takeout_ajzae += 1 ;
 game_button_18_bomb2.innerHTML = '<img class="gem"src="photo/gem.png"alt="gem_icon">';
 ...
 game_button_18_bomb2.innerHTML = '<img class="bomb bombanimetion"src="photo/bomb.png"alt="bomb_icon">';
 disabeler()
 song_bomb.play()
 takeout_ajzae += 100 ;
 money_tabdil = balance
...
if(shuffled[18] !== 2 && shuffled[18] !==7){
 ...
 money_tabdil += addermoney;
 takeout_ajzae += 1 ;
 game_button_19_bomb2.innerHTML = '<img class="gem"src="photo/gem.png"alt="gem_icon">';
 ...
 game_button_19_bomb2.innerHTML = '<img class="bomb bombanimetion"src="photo/bomb.png"alt="bomb_icon">';
 disabeler()
 song_bomb.play()
 takeout_ajzae += 100 ;
 money_tabdil = balance
...
if(shuffled[19] !== 2 && shuffled[19] !==7){
 ...
 money_tabdil += addermoney;
 takeout_ajzae += 1 ;
 game_button_20_bomb2.innerHTML = '<img class="gem"src="photo/gem.png"alt="gem_icon">';
 ...
 game_button_20_bomb2.innerHTML = '<img class="bomb bombanimetion"src="photo/bomb.png"alt="bomb_icon">';
 disabeler()
 song_bomb.play()
 takeout_ajzae += 100 ;
 money_tabdil = balance
...
if(shuffled[20] !== 2 && shuffled[20] !==7){
 ...
 money_tabdil += addermoney;
 takeout_ajzae += 1 ;
 game_button_21_bomb2.innerHTML = '<img class="gem"src="photo/gem.png"alt="gem_icon">';
 ...
 game_button_21_bomb2.innerHTML = '<img class="bomb bombanimetion"src="photo/bomb.png"alt="bomb_icon">';
 disabeler()
 song_bomb.play()
 takeout_ajzae += 100 ;
 money_tabdil = balance
...
if(shuffled[21] !== 2 && shuffled[21] !==7){
 ...
 takeout_ajzae += 1 ;
 money_tabdil += addermoney;
 game_button_22_bomb2.innerHTML = '<img class="gem"src="photo/gem.png"alt="gem_icon">';
 ...
 game_button_22_bomb2.innerHTML = '<img class="bomb bombanimetion"src="photo/bomb.png"alt="bomb_icon">';
 disabeler()
 song_bomb.play()
 takeout_ajzae += 100 ;
 money_tabdil = balance
...
if(shuffled[22] !== 2 && shuffled[22] !==7){
 ...
 money_tabdil += addermoney;
 takeout_ajzae += 1 ;
 game_button_23_bomb2.innerHTML = '<img class="gem"src="photo/gem.png"alt="gem_icon">';
 ...
 game_button_23_bomb2.innerHTML = '<img class="bomb bombanimetion"src="photo/bomb.png"alt="bomb_icon">';
 disabeler()
 song_bomb.play()
 takeout_ajzae += 100 ;
 money_tabdil = balance
...
if(shuffled[23] !== 2 && shuffled[23] !==7){
 ...
 takeout_ajzae += 1 ;
 game_button_24_bomb2.innerHTML = '<img class="gem"src="photo/gem.png"alt="gem_icon">';
 ...
 game_button_24_bomb2.innerHTML = '<img class="bomb bombanimetion"src="photo/bomb.png"alt="bomb_icon">';
 disabeler()
 song_bomb.play()
 takeout_ajzae += 100 ;
 money_tabdil = balance
...
if(shuffled[24] !== 2 && shuffled[24] !==7){
 ...
 takeout_ajzae += 1 ;
 game_button_25_bomb2.innerHTML = '<img class="gem"src="photo/gem.png"alt="gem_icon">';
 ...
 game_button_25_bomb2.innerHTML = '<img class="bomb bombanimetion"src="photo/bomb.png"alt="bomb_icon">';
 disabeler()
 song_bomb.play()
 takeout_ajzae += 100 ;
 money_tabdil = balance
...
function allwin(){
    ...
    money_fakebalance_shower.innerHTML = money_tabdil;
  if(takeout_ajzae === 23 ){
